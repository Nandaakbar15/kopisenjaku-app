...
@section('content')
    <div class="space-y-8">
        <div class="anim-fade-up" style="animation-delay: 0.05s;">
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Tambah Menu Baru</h1>
            <p class="text-slate-600 mt-2">Tambahkan menu produk kopi senjaku baru</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="mt-5">
                        <button type="submit"
                            ...
                            <i class="fa-solid fa-check mr-2"></i>Tambahkan Menu
                        </button>
                    </div>
