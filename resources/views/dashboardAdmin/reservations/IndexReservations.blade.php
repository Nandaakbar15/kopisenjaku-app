...
@section('content')
    <div class="space-y-8">
        ...
        <div class="anim-fade-up" style="animation-delay: 0.05s;">
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Halaman data reservation</h1>
        </div>
                    ...
                    @foreach ($reservations as $item)
                        <tr class="bg-neutral-primary border-b border-default">
                            ...
                            <td class="space-x-2 px-6 py-4">
                                <a href="/dashboard/reservations/details_reservations/{{ $item->id }}"
                                    class="inline-block text-white rounded-lg shadow-lg px-4 py-2 bg-blue-500 hover:bg-blue-700">
                                    Detail
                                </a>

                                <form action="/dashboard/reservations/delete_reservations/{{ $item->id }}"
