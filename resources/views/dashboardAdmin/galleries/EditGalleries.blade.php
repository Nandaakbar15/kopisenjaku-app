...
@section('content')
    <div class="space-y-8">
        <div class="anim-fade-up" style="animation-delay: 0.05s;">
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Edit Galleri</h1>
            <p class="text-slate-600 mt-2">Edit galleri kafe</p>
        </div>
        ...
        <div class="w-full max-w-full bg-white rounded-lg shadow-lg p-6 sm:p-8 anim-fade-up" style="animation-delay: 0.1s;">
            ...
            <form action="/dashboard/galleries/edit_galleries" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="gambarLama" value="{{ $galleries->image }}">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <!-- Judul Galleri -->
                    <div>
                        ...
                        <input type="text" id="title" name="title"
                            ...
                            placeholder="Masukan judul galleri" required value="{{ old('title', $galleries->title) }}" />
                        @error('title')
                    ...
                    <div>
                        <label for="image" class="block mb-2 text-sm font-medium text-slate-900">
                            Foto Kafe <span class="text-red-500">*</span>
                        </label>
                        <div class="mb-3">
                            <div
                    ...
                    <div class="mt-5">
                        <button type="submit"
                            ...
                            <i class="fa-solid fa-check mr-2"></i>Ubah Galleri
                        </button>
                    </div>
